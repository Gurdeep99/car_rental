...
<section class="ftco-section contact-section">
  <div class="container">
    <div class="row d-flex mb-5 contact-info">
      ...
      <form id="jobForm" action="job.php" method="POST" class="bg-light p-5 needs-validation" novalidate>
                        <div class="form-group">
                            <h2 class="d-flex justify-content-center"><strong>Become a Driver</strong></h2>
                            <input type="hidden" name="datasend" value="hi">
                        </div>
                        <div class="form-group">
                            <?php if (isset($_GET['success'])) {
                                echo "<div class='alert alert-success' role='alert'> Your Application Submitted </div>";
                            } ?>
                        </div>
