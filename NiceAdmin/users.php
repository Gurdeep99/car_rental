          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?php echo $row_ars['contact_number']; ?></td>

                <td><a href="edit_users.php?id=<?php echo $row_ars['id']; ?>&edit=true"><i class="bi bi-pencil-square"></i></a></td>
                <!-- <td><a href="users.php?id=<?php echo $row_ars['id']; ?>&delete=true"><i class="bi bi-trash"></i></a></td> -->
                <td><a onclick="sweetAlert('<?php echo $row_ars['id']; ?>','assets/users.php')"><i class="bi bi-trash"></i></a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
