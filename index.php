            ...
            <div class="col-md-12	featured-top">
                <div class="row no-gutters">
                    <div class="col-md-4 d-flex align-items-center">
                        <form action="assets/car_booking.php" method="POST" class="request-form ftco-animate bg-primary">
                            ...
                            <div class="d-flex">
                                <div class="form-group">
                                    ...
                                    <input name="pickup_date" id="pickup_date" type="date" class="form-control" min="<?php echo date('Y-m-d'); ?>" placeholder="Date" required>
                                </div>
                                <div class="form-group">
                                    <label for="" class="label">Drop-off date</label>
                                    <input name="dropoff_date" id="dropoff_date" type="date" class="form-control" min="<?php echo date('Y-m-d'); ?>" placeholder="Date" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex " style="justify-content: space-around; align-items: center;">
                                    <div>
                                        ...
                                        <label style="color: white; font-size: 15px; padding-left: 10px;">COD</label>
                                    </div>
                                    <div>
                                        <input name="payment_type" type="radio" value="upi/card">
                                        <label style="color: white; font-size: 15px; padding-left: 10px;">UPI / Card</label>
                                    </div>
                                </div>
                            </div>
...
<script>
    // Get references to the pick-up date and drop-off date input fields
    const pickupDateInput = document.getElementById('pickup_date');
    const dropoffDateInput = document.getElementById('dropoff_date');

    // Add event listener to the pick-up date input field
    pickupDateInput.addEventListener('change', function() {
        // Set the minimum value of the drop-off date input field to the selected pick-up date
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Check if URL contains the 'alert' parameter with value 'feature not working'
        var alertParam = getUrlParameter('success');
        if (alertParam === 'akgvialdkvbadkvbeasckdjvnksjghnbb') {
            // Display SweetAlert for UPI not working
            swal({
                title: "Thanks For Using Our Servies",
                text: "Your Car Has Been Rented Successfully",
                icon: "success",
                button: "OK",
            });
        }
